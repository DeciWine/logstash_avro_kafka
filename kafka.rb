...
class LogStash::Outputs::Kafka < LogStash::Outputs::Base
  ...
  def register
    ...
    if value_serializer == 'org.apache.kafka.common.serialization.StringSerializer'
      ...
      @codec.on_event do |event, data|
        #modified here,changed "data.to_java_bytes" to "data.to_java_object",because it will report "undefined method 'to_java_bytes' " in logstash-6.2.3.
        write_to_kafka(event, data.to_java_object)
      end
    else
